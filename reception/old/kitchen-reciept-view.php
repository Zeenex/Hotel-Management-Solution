...
$order = mysqli_query($mysqli, "SELECT * FROM kitchen_invoices WHERE inv_number='$inv_num'");
$order2 = mysqli_query($mysqli, "SELECT added_date FROM kitchen_invoices WHERE inv_number='$inv_num'");
                      ...
                      <tbody>
                        ...
                        <?php  } ?>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-4"><button name="submit" class="btn btn-primary btn-block">Print Reciept</button></div>
                              <div class="col-md-4">
