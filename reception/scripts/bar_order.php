...
mysqli_query($mysqli, "INSERT INTO restaurant_orders(order_number,source,staff,item_desc,quantity,added_date) VALUES ('".$ord_num."','".$source1."','".$rstaff1."','".$menu."','".$quantity."',NOW())");
...
$sql = "INSERT INTO restaurant_invoices(inv_number,source,staff,item_desc,quantity,price,total,added_date) VALUES ('".$inv_num."','".$source1."','".$rstaff1."','".$menu."','".$quantity."','".$price_items."','".$total_price."',NOW())";
      ...
      if($result){
        ...
        header("Location: ../bar-order.php?msg=Order placed!");

      }else{

        
        header("Location: ../bar-order.php?msg=There was an error, please check!");
