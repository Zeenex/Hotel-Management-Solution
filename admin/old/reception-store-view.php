...
$store = mysqli_query($mysqli, "SELECT * FROM hotel_storage");
...
?>
 ...
 if(isset($_POST["submit"])){
  ...
  if(isset($_POST["item_name"])){
    ...
    $userpro = mysqli_query($mysqli, "SELECT * FROM hotel_storage where item_name = '".$item_name."'");
                ...
                while($row=mysqli_fetch_array($userpro)){
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="reception_item_edit.php?item_num='.$row['item_no'].'">Edit</a>
                          </td>
                        </tr>
    ...
    echo "<script>";echo " alert('Please select a name');window.location.href='reception-store-view.php';</script>";
  }
}
