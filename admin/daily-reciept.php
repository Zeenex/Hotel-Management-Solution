...
$query1 =  mysqli_query($mysqli,"SELECT * FROM `accounting_invoices` WHERE added_date >= curdate() GROUP BY inv_number");
              ...
              <div class="card">
                <div class="card-header card-header-primary">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-4" style="text-align: center;"><h4 class="card-category">Daily Reciept Report</h4></div>
                              <div class="col-md-4">
                            ...
                            <div class="row py-lg-5">
                              ...
                              <div class="table-responsive">
                                ...
                                <td>  </td>
                                  ...
                                  <td>
                                 <a href="reciept-view.php?inv_num='.$rows['inv_number'].'"><i class="fa fa-edit" style="color: green"></i></a>
                                 &nbsp;&nbsp;
