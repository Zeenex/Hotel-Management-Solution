...
?>
 ...
 if(isset($_POST["submit"])){
  ...
  if(isset($_POST["item_name"])){
    ...
    $userpro = mysqli_query($mysqli, "SELECT * FROM restaurant_storage where item_name = '".$item_name."'");
                ...
                while($row=mysqli_fetch_array($userpro)){
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="restaurant-store-edit.php?item_num='.$row['item_no'].'"><i class="fa fa-edit" style="color: green"></i> </a>
                            &nbsp;&nbsp;
                            <a onclick="return confirm(\'sure to DELETE MENU !\');" href="scripts/restaurant_store_del.php?item_num='.$row['item_no'].'"><i class="fa fa-trash" style="color: red"></i> </a>
                            </td>
                        </tr>
    ...
    echo "<script>";echo " alert('Please select a name');window.location.href='restaurant-store-view.php';</script>";
  }
}
