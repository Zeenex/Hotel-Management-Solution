...
mysqli_query($mysqli, "INSERT INTO accounting_orders(order_number,source,staff,item_desc,quantity,added_month,added_date) VALUES ('".$ord_num."','".$source1."','".$rstaff1."','".$item."','".$quantity."',MONTHNAME(CURRENT_DATE),NOW())");

mysqli_query($mysqli, "INSERT INTO accounting_invoices(inv_number,source,staff,item_desc,quantity,price,total,month,added_date) VALUES ('".$inv_num."','".$source1."','".$rstaff1."','".$item."','".$quantity."','".$price_items."','".$total_price."',MONTHNAME(CURRENT_DATE),NOW())");
