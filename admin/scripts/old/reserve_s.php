	...
	//Selecting database
		...
		if($numrows == 0)
		{
			...
			if($result){
				...
				echo "<script>";echo " alert(' Customer have been Reserved ');window.location.href='../reception-view-reserved.php';</script>";

			}else{

				
				
				echo "<script>";echo " alert('There was an error, please check');window.location.href='../reception-create-reserve.php';</script>";
			}

		}else{

			echo "<script>";echo " alert('This customer already exist on record');window.location.href='../reception-create-reserve.php';</script>";
		}
