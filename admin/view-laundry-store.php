            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">View Laundry Store Items</h4>
    ...
    $userpro = mysqli_query($mysqli, "SELECT * FROM laundary_storage where item_name = '".$item_name."'");
                ...
                while($row=mysqli_fetch_array($userpro)){
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="laundry-store-edit.php?item_num='.$row['item_no'].'"><i class="fa fa-edit" style="color: green"></i> </a>
                            &nbsp;&nbsp;
                            <a onclick="return confirm(\'sure to DELETE MENU !\');" href="scripts/laundry_store_del.php?item_num='.$row['item_no'].'"><i class="fa fa-trash" style="color: red"></i> </a>
                            </td>
                        </tr>
