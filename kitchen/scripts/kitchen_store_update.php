...
if(isset($_POST["item_name"])  && isset($_POST["item_brand"]) && isset($_POST["item_qty"]) && isset($_POST["item_serial"]) && isset($_POST["item_cost"])){
	...
	$sql = "UPDATE kitchen_storage SET item_name = '$item_name1',item_brand='$item_brand1',item_serial='$item_serial1',item_qty='$item_qty1',item_cost='$item_cost1',total_item_cost='$total_item_cost1',date_added=NOW() WHERE item_no = '$item_num'";
