...
<head>
  ...
  <title>
    Homegate Management Solution - Laundry
  </title>
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#ui-menu" aria-expanded="false" aria-controls="ui-menu">
              ...
              <p><b>Laundry Orders</b><span style="float: right;"><img src="../assets/img/icons/expand_more.svg" alt=""></span></p>              
              
            </a>
            <div class="collapse" id="ui-menu">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="./create-order.php"><i class="material-icons">dry_cleaning</i><p>Create an Order</p></a></li>
                <li class="nav-item"> <a class="nav-link" href="./view-laundary-order.php"><i class="material-icons">receipt_long</i><p>View Orders</p></a></li>
                <li class="nav-item"> <a class="nav-link" href="./view-laundary-receipts.php"><i class="material-icons">receipt_long</i><p>View Receipts</p></a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
