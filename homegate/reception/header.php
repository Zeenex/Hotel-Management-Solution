...
<head>
  ...
  <title>
    Homegate Management Solution - Reception
  </title>
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#ui-room" aria-expanded="false" aria-controls="ui-room">
              ...
              <p><b>Manage Rooms</b><span style="float: right;"><img src="../assets/img/icons/expand_more.svg" alt=""></span></p>              
              
            </a>
            <div class="collapse" id="ui-room">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="./view-room.php"><i class="material-icons">room_preferences</i><p>Assign Rooms</p></a></li>
                <li class="nav-item"> <a class="nav-link" href="./view-room-assigned.php"><i class="material-icons">credit_card</i><p>View Assigned Keys Cards</p></a></li>                
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#ui-customer" aria-expanded="false" aria-controls="ui-customer">
              ...
              <p><b>Manage Customers</b><span style="float: right;"><img src="../assets/img/icons/expand_more.svg" alt=""></span></p>              
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#ui-process" aria-expanded="false" aria-controls="ui-process">
              
              <p><b>Customers Process</b><span style="float: right;"><img src="../assets/img/icons/expand_more.svg" alt=""></span></p>              
              
            </a>
            <div class="collapse" id="ui-process">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="./view-menu.php"><i class="material-icons">restaurant_menu</i><p>View Food Menu</p></a></li>
                <li class="nav-item"> <a class="nav-link" href="./kitchen-order.php"><i class="material-icons">room_service</i><p>Place kitchen Order </p></a></li>
                <li class="nav-item"> <a class="nav-link" href="./laundary-order.php"><i class="material-icons">checkroom</i><p>Place Laundary Order</p></a></li>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#ui-reciept" aria-expanded="false" aria-controls="ui-reciept">              
              <p><b>Manage Receipts</b><span style="float: right;"><img src="../assets/img/icons/expand_more.svg" alt=""></span></p>       
