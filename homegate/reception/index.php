...
$dash1 = mysqli_query($mysqli, "SELECT * FROM accounting_orders WHERE source='Reception' AND added_date >= curdate() GROUP BY order_number");
$daily_count = ($row = mysqli_num_rows($dash1));

$dash2 = mysqli_query($mysqli, "SELECT * FROM accounting_orders WHERE source='Reception' GROUP BY order_number");
$order_count = ($row = mysqli_num_rows($dash2));

$dash3 = mysqli_query($mysqli, "SELECT * FROM staff WHERE role='reception'");
