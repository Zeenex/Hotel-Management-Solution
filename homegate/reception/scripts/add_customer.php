...
if(isset($_POST["room_num"])  && isset($_POST["c_in_date"]) && isset($_POST["c_out_date"])){
	...
	header("Location: ../add-customer.php?msg='Room Details Fields Required!");
