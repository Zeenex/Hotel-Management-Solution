...
if(isset($_POST["submit"])){
	...
	$sql = "UPDATE restaurant_storage SET item_name = '$item_name1',item_type='$item_type1',item_category='$item_cat1',item_condition='$item_cond1',item_sku='$item_sku1',item_serial='$item_serial1',item_isbn='$item_isbn1',item_color='$item_color1',manuf_date='$manuf_date1',exp_date='$expiry_date1',unit_cost='$item_cost1',warranty='$item_warranty1',unit_measure='$unit_measure1',quantity='$item_qty1',total_item_cost='$total_item_cost1',date_added=NOW() WHERE item_no = '$item_num'";

			$result = mysqli_query($mysqli, $sql);

			if($result){

				header("Location: ../view-restaurant-store.php?msg=Item successfully updated!");
				

			}else{

				header("Location: ../view-restaurant-store.php?msg=There was an error, please check!");
