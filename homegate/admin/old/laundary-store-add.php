          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="scripts/laundary_store_add.php" method='post'>
                    <div class="row">
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="item_serial" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Item Cost</label>
                          <input type="text" name="item_cost" class="form-control">
                        </div>
                      </div>
                    </div>
