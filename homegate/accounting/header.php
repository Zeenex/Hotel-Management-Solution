...
<head>
  ...
  <title>
    Homegate Management Solution - Accounting
  </title>
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-order">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="./all-order.php"><i class="material-icons">receipt_long</i><p>All Orders</p></a></li>
                <li class="nav-item"> <a class="nav-link" href="./daily-orders.php"><i class="material-icons">receipt_long</i><p>Generate Daily Orders</p></a></li>              
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-reciept">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="./all-receipt.php"><i class="material-icons">receipt_long</i><p>All Receipts</p></a></li>
                <li class="nav-item"> <a class="nav-link" href="./daily-reciept.php"><i class="material-icons">receipt</i><p>Generate Daily Reciepts</p></a></li>              
          ...
          <li class="nav-item"> <a class="nav-link" href="./view-daily.php"><i class="material-icons">receipt</i><p>Daily Receipts Report</p></a></li>
          <li class="nav-item"> <a class="nav-link" href="./view-monthly.php"><i class="material-icons">receipt</i><p>Monthly Receipts Report</p></a></li>
